...
$GLOBALS['TCA']['tx_vmfdsadventskalender_domain_model_window'] = array(
	...
	'interface' => array(
		'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, day, type, event_id, name, address, phone, email, notes, internal_notes, image',
	),
	'types' => array(
		'1' => array('showitem' => 'sys_language_uid;;;;1-1-1, l10n_parent, l10n_diffsource, hidden;;1, day, type, event_id, name, address, phone, email, notes, internal_notes, image, --div--;LLL:EXT:cms/locallang_ttc.xlf:tabs.access, starttime, endtime'),
	),
	'palettes' => array(
		'1' => array('showitem' => ''),
	),
	'columns' => array(
		...
		'type' => array(
			'exclude' => 1,
			'label' => 'LLL:EXT:vmfds_adventskalender/Resources/Private/Language/locallang_db.xlf:tx_vmfdsadventskalender_domain_model_window.type',
			'config' => array(
				'type' => 'select',
				'items' => array(
					array('-- Label --', 0),
